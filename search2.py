...
""""
datasets.py 143行设置是开启摄像头还是读取图片
...
def detect(cfg,
    ...
    for i, (path, img, im0, vid_cap) in enumerate(dataloader):
        ...
        if opt.webcam:  # Show live webcam
            ...
            cv2.imshow('lyl_reid_camera', im0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-q', '--query', default=r'F:\biyesheji\xiaolunwen\lyl_reid\query\jiank_query.jpg', help='查询图片的读取路径.')
    ...
    parser.add_argument('--dist_thres', type=float, default=10.0, help='行人图片距离阈值，小于这个距离，就认为是该行人')
