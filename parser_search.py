...
parser.add_argument('-q', '--query', default=r'F:\毕业设计\刘亚蕾毕业论文\lyl_reid\query\query.png', help='查询图片的读取路径.')
...
parser.add_argument('--dist_thres', type=float, default=100.0, help='行人图片距离阈值，小于这个距离，就认为是该行人')
