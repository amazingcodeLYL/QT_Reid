...
if __name__ == '__main__':
    ...
    parser.add_argument('-q', '--query', default=r'F:\biyesheji\xiaolunwen\lyl_reid\person_search_demo-master\person_search_demo-master\query\query2.jpg', help='查询图片的读取路径.')
    ...
    parser.add_argument('--dist_thres', type=float, default=2.0, help='行人图片距离阈值，小于这个距离，就认为是该行人')
